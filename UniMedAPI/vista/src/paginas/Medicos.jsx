        ...
        <div className="tarjeta">
          ...
          <form onSubmit={guardarMedico}>
            <div className="grupo-form">
              ...
              <input id="nombreMedico" name="nombreMedico" type="text" className="control-form" value={nombre} onChange={(e) => setNombre(e.target.value)} required />
            </div>
            
            <div className="grupo-form">
              <label htmlFor="especialidadMedico">Especialidad:</label>
              <input id="especialidadMedico" name="especialidadMedico" type="text" className="control-form" value={especialidad} onChange={(e) => setEspecialidad(e.target.value)} required />
            </div>
            
            <div className="grupo-form">
              <label htmlFor="telefonoMedico">Teléfono:</label>
              <input id="telefonoMedico" name="telefonoMedico" type="text" className="control-form" value={telefono} onChange={(e) => setTelefono(e.target.value)} required />
            </div>
