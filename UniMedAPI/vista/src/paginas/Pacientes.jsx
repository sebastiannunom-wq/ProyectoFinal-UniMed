...
export default function Pacientes() {
  ...
  const seleccionarPaciente = (paciente) => {
    ...
    if (paciente.fechaNacimiento && paciente.fechaNacimiento.includes('T')) {
        ...
        <div className="tarjeta">
          ...
          <form onSubmit={guardarPaciente}>
            <div className="grupo-form">
              ...
              <input id="nombrePaciente" name="nombrePaciente" type="text" className="control-form" value={nombre} onChange={(e) => setNombre(e.target.value)} required />
            </div>
            
            <div className="grupo-form">
              <label htmlFor="telefonoPaciente">Teléfono:</label>
              <input id="telefonoPaciente" name="telefonoPaciente" type="text" className="control-form" value={telefono} onChange={(e) => setTelefono(e.target.value)} required />
            </div>
            
            <div className="grupo-form">
              <label htmlFor="fechaNacimientoPaciente">Fecha de Nacimiento:</label>
              <input id="fechaNacimientoPaciente" name="fechaNacimientoPaciente" type="date" className="control-form" value={fechaNacimiento} onChange={(e) => setFechaNacimiento(e.target.value)} required />
            </div>
